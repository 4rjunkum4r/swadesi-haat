      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row">
          ...
          >
            ...
            >
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8">
                {isSignUp
                  ? "Join  and shop indigenous product :)"
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                >
                  ...
                  <span className="hidden sm:inline-block sm:ml-2">Gmail</span>
                </Button>
                <Button
                  variant="outline"
                  size="icon"
        ...
        >
          <div className="space-y-12 h-full flex flex-col items-center justify-center">
            <motion.div
              className="bg-black bg-opacity-50 p-8 rounded-lg justify-center"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {isSignUp ? (
                <>
                  ...
                  <p className="text-5xl font-bold mb-4">1,203</p>
                ...
                <div className="p-3 py-0">
                  ...
                  <div className="flex items-center mb-4">
                    {[...Array(5)].map((_,i)=>(<Star key={i} className="text-yellow-400 h-8 w-8 mr-1"/>))}
